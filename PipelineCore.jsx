  ...
  return (
    <div className="flex flex-col items-center p-8 bg-gray-50 min-h-screen font-sans">
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <Node
          type="lambda"
          title="Lambda: Swing Landmark Detection"
          details="~13s signal processing. Detects backswing apex & contact/impact frames."
        />
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <Node
          type="lambda"
          title="Lambda: Score Finder"
          details="Reads .json, .pkl, .mp4. Detects raised hands & predicts finger count."
        >
